...
public enum AggregationFunctionType {
  ...
  DISTINCTCOUNTHLL("distinctCountHLL", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTRAWHLL("distinctCountRawHLL", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTSMARTHLL("distinctCountSmartHLL", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.CHARACTER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  @Deprecated FASTHLL("fastHLL"),
  DISTINCTCOUNTHLLPLUS("distinctCountHLLPlus", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTRAWHLLPLUS("distinctCountRawHLLPlus", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTULL("distinctCountULL", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTRAWULL("distinctCountRawULL", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTTHETASKETCH("distinctCountThetaSketch", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.CHARACTER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTRAWTHETASKETCH("distinctCountRawThetaSketch", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.CHARACTER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTTUPLESKETCH("distinctCountTupleSketch", ReturnTypes.BIGINT, OperandTypes.BINARY, SqlTypeName.OTHER),
  DISTINCTCOUNTRAWINTEGERSUMTUPLESKETCH("distinctCountRawIntegerSumTupleSketch", ReturnTypes.VARCHAR_2000,
  ...
  DISTINCTCOUNTCPCSKETCH("distinctCountCPCSketch", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.ANY), ordinal -> ordinal == 1), SqlTypeName.OTHER),
  DISTINCTCOUNTRAWCPCSKETCH("distinctCountRawCPCSketch", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.ANY), ordinal -> ordinal == 1), SqlTypeName.OTHER),
  ...
  PERCENTILERAWEST("percentileRawEst", ReturnTypes.VARCHAR_2000, OperandTypes.ANY_NUMERIC, SqlTypeName.OTHER),
  PERCENTILETDIGEST("percentileTDigest", ReturnTypes.DOUBLE,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILERAWTDIGEST("percentileRawTDigest", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILESMARTTDIGEST("percentileSmartTDigest", ReturnTypes.DOUBLE,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.NUMERIC, SqlTypeFamily.CHARACTER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILEKLL("percentileKLL", ReturnTypes.DOUBLE,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILERAWKLL("percentileRawKLL", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),

  IDSET("idSet", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.CHARACTER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  ...
  FREQUENTSTRINGSSKETCH("frequentStringsSketch", ReturnTypes.VARCHAR_2000, OperandTypes.ANY, SqlTypeName.OTHER),
  FREQUENTLONGSSKETCH("frequentLongsSketch", ReturnTypes.VARCHAR_2000, OperandTypes.ANY, SqlTypeName.OTHER),
  ...
  ARRAYAGG("arrayAgg", ReturnTypes.TO_ARRAY,
      OperandTypes.family(List.of(SqlTypeFamily.ANY, SqlTypeFamily.CHARACTER, SqlTypeFamily.BOOLEAN),
          ordinal -> ordinal == 1), SqlTypeName.OTHER),
  ...
  DISTINCTCOUNTHLLMV("distinctCountHLLMV", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTRAWHLLMV("distinctCountRawHLLMV", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTHLLPLUSMV("distinctCountHLLPlusMV", ReturnTypes.BIGINT,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  DISTINCTCOUNTRAWHLLPLUSMV("distinctCountRawHLLPlusMV", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.INTEGER), ordinal -> ordinal == 1),
      SqlTypeName.OTHER),
  ...
  PERCENTILEESTMV("percentileEstMV", ReturnTypes.DOUBLE,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.NUMERIC)), SqlTypeName.OTHER),
  PERCENTILERAWESTMV("percentileRawEstMV", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.NUMERIC)), SqlTypeName.OTHER),
  PERCENTILETDIGESTMV("percentileTDigestMV", ReturnTypes.DOUBLE,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILERAWTDIGESTMV("percentileRawTDigestMV", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILEKLLMV("percentileKLLMV", ReturnTypes.DOUBLE,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER),
  PERCENTILERAWKLLMV("percentileRawKLLMV", ReturnTypes.VARCHAR_2000,
      OperandTypes.family(List.of(SqlTypeFamily.ARRAY, SqlTypeFamily.NUMERIC, SqlTypeFamily.INTEGER),
          ordinal -> ordinal == 2), SqlTypeName.OTHER);
